...
The Healthy Eating Index (HEI) \citep{guenther_development_2008, guenther_evaluation_2008} is a food index based on the USDA Dietary Guidelines for Americans \citep{us_health_and_human_services_dietary_2005}. The original HEI was developed in 1995 and revised in 2006 to reflect the 2005 Dietary Guidelines. Throughout the rest of this document, the acronym `HEI' refers to the 2005 version of the HEI. 
