...
\fbox{\includegraphics[ width =2.5cm ]{./images/cont2/fig1a}}
\label{fig:fig2_1a}
}
\subfloat[ Viz2 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[ width =2.5cm ]{./images/cont2/fig1b}}
\label{fig:fig2_1b}
}
\subfloat[ Viz3 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[ width  =2.5cm ]{./images/cont2/fig1c}}
\label{fig:fig2_1c}
}
\subfloat [ Viz4 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics [ width  =2.5cm ]{./images/cont2/fig1d}}
\label{fig:fig2_1d}
}
\caption{HEI Screens.}
\end{center}
...
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[ width =2.5cm ]{./images/cont2/fig2a}}
\label{fig:fig2_2a}
}
\subfloat[ Viz2 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[ width =2.5cm ]{./images/cont2/fig2b}}
\label{fig:fig2_2b}
}
\subfloat[ Viz3 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[ width  =2.5cm ]{./images/cont2/fig2c}}
\label{fig:fig2_2c}
}
\subfloat [ Viz4 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics [ width  =2.5cm ]{./images/cont2/fig2d}}
\label{fig:fig2_2d}
}
\subfloat [ Viz4 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics [ width  =2.5cm ]{./images/cont2/fig2e}}
\label{fig:fig2_2e}
}
\caption{FBQI Screens.}
\end{center}
\end{figure}
...
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[ width =2.5cm ]{./images/cont2/fig3a}}
\label{fig:fig2_3a}
}
\subfloat[ Viz2 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[ width =2.5cm ]{./images/cont2/fig3b}}
\label{fig:fig2_3b}
}
\subfloat[ Viz3 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics[ width  =2.5cm ]{./images/cont2/fig3c}}
\label{fig:fig2_3c}
}
\subfloat [ Viz4 ]{
\setlength\fboxsep{0pt}
\setlength\fboxrule{0.5pt}
\fbox{\includegraphics [ width  =2.5cm ]{./images/cont2/fig3d}}
\label{fig:fig2_3d}
}
\caption{BALANCE Screens.}
\end{center}
\end{figure}
