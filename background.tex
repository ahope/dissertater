...
\textbf{crap paragraph}
How do i capture this thought of ``the waters get muddy'', in that the design of the tools don't always reflect the ultimate goal of the research? If the researcher is trying to evaluation behavior change, they should build tools that do x-y-z related to that; if they are trying to snapshot existing behavior without changing it, it should do different things. And evaluation. How does the evaluation reflect the goal, and does the design of the instrument/intervention truly reflect the goal?
...
The Wellness Diary (WD) \citep{mattila_mobile_2008, ahtinen_user_2009, mattila_nuadu_2008} is an application designed and built by a consortium of researchers in Finland. The Wellness Diary itself runs on Symbian smartphones, and is designed to allow users to track small aspects of one's health and wellness behaviors such as quality of food intake, amount of physical activity, sleep, stress levels, and amount of time spent at work for the day. 
In [28], Matilla et al evaluated the use of the Wellness Diary by two groups of people. The first group, the weight management group, was a self-selected group of 29 people who were overweight and owned a phone that could run the software. This group was asked to use the WD as part of a cognitive behavioral therapy (CBT)-based weight management program. The second group (for general wellness management) consisted of 17 volunteers who were participating in a work-related rehabilitation program, and had high burnout scores. This group was using WD to help them track stress-related indicators as part of a larger rehabilitation program. 
...
In this section, I'm going to describe the different areas of research, and list out some of the work that reflects it. 
