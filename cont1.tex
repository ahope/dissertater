...
Additional details about the BALANCE validation study are reported in Snively ([ref]). There, in regards to the food diary, she reports on the overall calories entered into the food diary, the calories reported on the food recall, and analyzes discrepancies. She reports feedback on the usability of the software, but does not report on metrics that indicate patterns of use of the BALANCE food diary. 
...
\item{App starts}
	\begin{itemize*}
		\item{Per day}
		\item{Throughout the day}
	\end{itemize*}
\item{Entry creation time}
\item{Reported food eaten time}
\item{Entry edits}
...
\begin{table}[htbp]
  ...
  \caption{Add caption}
    \begin{tabular}{rrr}
    \toprule
          & Mean Days 1-4 & Mean Days 1-5 \\
    \midrule
    App Starts per day & 2.7   & 2.3 \\
    Entries Created & 9.5   & 8.42 \\
    Food Eaten & 9.67  & 8.2 \\
    Edits & 3.02  & 2.97 \\
    \bottomrule
    \end{tabular}%
...
Throughout this section, I report metrics over the five days following the start of the study, per participant. Days 1-4 reflect active participation in the study. Food diary use on day 5 reflects modifications to the earlier data. To characterize patterns of use over time, each study day is broken into six 4-hr periods, summarized in Table \ref{tab:studyDayTimePeriods}. No distinction is made between weekends and weekdays. 
...
Figure \ref{fig:chart} shows how many valid food entries were reported as being eaten in the given time period, independent of when they were created. 
