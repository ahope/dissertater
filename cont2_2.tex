...
\fbox{\includegraphics[width=1.25in]{./images/cont2/fig1d}}
		\caption{HEI Screens}\label{fig:fig3_1d}
	\end{subfigure}
...
All pairwise corisons are significant using Holm's sequential Bonferroni procedure (alpha = 0.05). We can accept our alternative hypothesis that HEI and FBQI are faster than BAL, and more so, we have found that FBQI is significantly faster than HEI. 
